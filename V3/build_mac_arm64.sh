#!/usr/bin/env bash
# Build MakeAGIF v3.1.9 for macOS Apple Silicon (.app bundle).
...
python3 -m PyInstaller --noconfirm MakeAGIF_v3.1.9_mac.spec

echo ""
echo "Done: dist/MakeAGIF v3.1.9.app"
echo "Bundled tools: ffmpeg, ffprobe, gifski, img2webp (macOS WebP encoder)"
echo "Test: open \"dist/MakeAGIF v3.1.9.app\""
