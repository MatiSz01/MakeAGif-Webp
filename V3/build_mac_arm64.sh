#!/usr/bin/env bash
# Build MakeAGIF v3.1.4 for macOS Apple Silicon (.app bundle).
...
python3 -m PyInstaller --noconfirm MakeAGIF_v3.1.4_mac.spec

echo ""
echo "Done: dist/MakeAGIF v3.1.4.app"
echo "Bundled tools: ffmpeg, ffprobe, gifski, magick (parity with Windows tools/)"
echo "Test: open \"dist/MakeAGIF v3.1.4.app\""
