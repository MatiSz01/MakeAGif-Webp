#!/usr/bin/env bash
# Build MakeAGIF v3.1.10 for macOS Apple Silicon (.app bundle).
...
python3 -m PyInstaller --noconfirm MakeAGIF_v3.1.10_mac.spec

echo ""
echo "Done: dist/MakeAGIF v3.1.10.app"
echo "Bundled tools: ffmpeg, ffprobe, gifski, img2webp (macOS WebP encoder)"
echo "Test: open \"dist/MakeAGIF v3.1.10.app\""
