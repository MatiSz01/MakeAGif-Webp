# =============================================================================
# MakeAGIF v3.1.2 — DND Prototype (macOS release: full tools parity + trim async)
# =============================================================================
# Forked from v3.1.1; macOS App Store–style release with bundled magick + v3.1.1 trim UX.
...
APP_TITLE = f"MakeAGIF/WEBP v3.1.2 — By {APP_AUTHOR}"
